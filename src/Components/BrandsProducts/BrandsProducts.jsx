...
export default function BrandsProducts() {
  // Retrieve the brand name from the URL parameters
  ...
  // useEffect hook to fetch products whenever brandName changes
  useEffect(() => {
    GetSpecificBrand();
  }, [brandName]);
